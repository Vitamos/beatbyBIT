 ...
 * said device.
 */
public class BITalinoDevice implements Serializable {
    ...
    /**
     * @param samplerate     the sampling frequency (Hz). Values available are 1000 (default),
     *                       100, 10 and 1.
     * @param analogChannels the analog channels to read from.
     * @throws BITalinoException if analog channels are not valid.
     */
